...
jsPsych.plugins['html-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<div class=htmlSliderResponse2> <strong>Your estimation:</strong>';
    ...
    html += '<div class="scaleValues"><span>0%</span><span>25%</span><span>50%</span><span>75%</span><span>100%</span></div> ';
    html += '</div>';
    html += '</div>';
    html += '</div>';
