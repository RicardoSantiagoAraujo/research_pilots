...
jsPsych.plugins['html-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<div id="jspsych-html-slider-response-stimulus" >' + trial.stimulus;
    html += '<div class=htmlSliderResponse2> <strong>Your vote:</strong>';
    ...
    html += '<div class="scaleValues"><span>0</span><span>1</span><span>2</span><span>3</span><span>4</span><span>5</span><span>6</span><span>7</span><span>8</span><span>9</span><span>10</span></div> ';
    html += '</div>';
    html += '</div>';
    html += '</div>';
    ...
    html += "<br><br><video src='../vid/countdown15s.mp4' height = 70 autoplay = true>";
